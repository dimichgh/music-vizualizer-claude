...
var createWindow = function createWindow() {
  ...
  var startUrl = 'http://localhost:3000/main_window/index.html';
  mainWindow.loadURL(startUrl);
  if (electron_is_dev__WEBPACK_IMPORTED_MODULE_3__) {
...
electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.handle('open-wav-file', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  var _yield$dialog$showOpe, canceled, filePaths, filePath, buffer, _t;
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      ...
      case 1:
        _context.n = 2;
        return electron__WEBPACK_IMPORTED_MODULE_0__.dialog.showOpenDialog(mainWindow, {
          properties: ['openFile'],
          filters: [{
            name: 'Audio',
            extensions: ['wav']
      ...
      case 2:
        _yield$dialog$showOpe = _context.v;
      ...
      case 3:
        ...
        _context.p = 4;
        // Read file as buffer
        buffer = fs__WEBPACK_IMPORTED_MODULE_2__.readFileSync(filePath); // Return file details
        return _context.a(2, {
          canceled: false,
          filePath: filePath,
      ...
      case 5:
        _context.p = 5;
        _t = _context.v;
        console.error('Error reading WAV file:', _t);
        return _context.a(2, {
          canceled: true,
          error: _t.message
        });
